...
if __name__ == "__main__":
    vk = VK("VK", ["пользователь1", "пользователь2"], ["группа1", "группа2"])
    facebook = Facebook("Facebook", ["пользователь3", "пользователь4"], ["страница1", "страница2"])

    print(vk)
    print(repr(vk))
    vk.добавить_пользователя("user5")
    vk.добавить_группу("группа3")
