...
class Стол(ABC):
    ...
    def __init__(self, материал: str, количество_ножек: int):
        ...
        :вызывает ошибку ValueError: если количество ножек меньше 1 или больше 10.
        """
...
class Дерево(ABC):
    ...
    def __init__(self, рост: float, возраст: int):
        """
...
class СоциальнаяСеть(ABC):
    ...
    def описание(self) -> str:
        ...
        >>> сеть = Facebook («Facebook», 2000000000)
        >>> сеть.описание()
        «Социальная сеть Facebook с 200 000 000 пользователей».
        """
        ...
...
class Дуб(Дерево):
    ...
    def описание(self) -> str:
        return f"Дерево высотой {self.рост} метров и возрастом {self.возраст} лет."
...
class Facebook(СоциальнаяСеть):
    ...
    def описание(self) -> str:
        return f"Социальная сеть {self.название} с {self.количество_пользователей} пользователями."
...
if __name__ == "__main__":
    ...
    сеть.добавить_пользователя()
    print(сеть.описание()) # Вывод: социальная сеть Facebook с 2000000001 пользователем.